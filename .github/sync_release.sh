...
UPSTREAM_REPO="https://github.com/MiSTer-devel/AtariLynx_MiSTer.git"
CORE_NAME=(AtariLynx)
...
UPSTREAM_CORE_NAME=(AtariLynx)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(AtariLynx.qpf)
COMPILATION_OUTPUT=(output_files/AtariLynx.rbf)
